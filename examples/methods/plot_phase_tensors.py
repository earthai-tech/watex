...
# For demonstration, we will use the data collected from Huayuan (:func:`watex.datasets.huayuan`)
...
tplot.plot_phase_tensor (tensor='skew' )

# %% 
# * Determinant of phase tensor 'phidet'
tplot.plot_phase_tensor (tensor='phidet' )
