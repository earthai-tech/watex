...
class Data: 
    """ Abstract Base Data class and can not be instanciated 
    ...
    def fit(self, data: str | DataFrame = None):
        f""" Read, assert and fit the data 
...
class Missing (Data) : 
    ...
    def plot(self, data: str | DataFrame=None , **kwd ):
        ...
        missing(self.plot_, self.data, kind =  self.kind, 
