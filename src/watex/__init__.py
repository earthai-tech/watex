...
the main advantage using `WATex`_ is the application of machine learning methods 
in the hydrogeophysic parameter predictions. It contributes to minimize the risk 
of unsucessfull drillings and the hugely reduce the cost of the hydrogeology 
